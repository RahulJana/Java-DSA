...
public class Main {
    ...
    public static class LinkedList {
        ...
        /*
         * You are required to complete the body of oddEven function. The function is
        ...
        public void oddEven() {
            ...
            if (oddList.size > 0 && evenList.size > 0) { // When Odd and even both elements are present.
                oddList.tail.next = evenList.head;
                this.head = oddList.head;
                this.tail = evenList.tail;
                this.size = oddList.size + evenList.size;
            } else if (oddList.size > 0) { // Only Odd present
                this.head = oddList.head;
                this.tail = oddList.tail;
                this.size = oddList.size;
            } else if (evenList.size > 0) { // Only even present
